...
- **[Skyvern-AI/skyvern](https://github.com/Skyvern-AI/skyvern/tree/main/skyvern/cli/skills/skyvern)** - AI browser automation: dynamic pages, forms, data extraction, CAPTCHAs, and logins  
